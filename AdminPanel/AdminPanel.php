<div id="AdminPanel" class="dcms-make-draggable">
    ...
    <button title="Hint: Click to show | Double click to hide..." onclick="showAppPanel('Earnings')"
            ondblclick="hideAppPanel('Earnings')" class="dcms-button admin-panel-button">Earnings
    </button>
    <button title="Hint: Click to show | Double click to hide..." onclick="showAppPanel('PHPMyAdminFrame')"
            ondblclick="hideAppPanel('PHPMyAdminFrame')" class="dcms-button admin-panel-button">PHP My Admin Frame
    </button>
