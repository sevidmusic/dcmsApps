...
$createAppForm->addFormElement(new \DarlingCms\classes\html\form\Text('appName'));
$createAppForm->addFormElement(new \DarlingCms\classes\html\form\Submit('createApp', 'Create New App'));
