...
$createActionForm = new \DarlingCms\classes\html\form\Form(
    ...
    [
        ...
        'onsubmit' => 'return ' . \DarlingCms\abstractions\userInterface\AjaxUI::generateAjaxRequest([
                ...
                'requestType' => 'POST',
                'contentType' => '',
                'additionalParams' => 'actionName=\'+getElementValue(\'actionNameFormElement\')+\'&' . 'actionDescription=\'+getElementValue(\'actionDescriptionFormElement\')+\'',
                //'additionalParams' => 'actionName=\'+document.getElementById(\'actionNameFormElement\').value+\'&' . 'actionDescription=\'+document.getElementById(\'actionDescriptionFormElement\').value+\'',
